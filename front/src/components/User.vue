<template>
    <div class="user">
        <input type="text" v-model="$root.user.id" @keyup="getUser()" placeholder="User ID..."/>
                ...
                <div>
                    <md-card style="width:300px">
                        ...
                        <md-card-actions>
                            ...
                            <md-button class="md-icon-button" md-menu-trigger @click="deleteForm.showDialog = true">
                            ...
                            <md-menu>
                                ...
                                <md-menu-content>
                                    <md-menu-item>
                                        <router-link :to="{name: 'workingTimes', params: {userId: userChange.id}}" class="list_menu">WorkingTimes</router-link>
                                    </md-menu-item>
<!--                                    <md-menu-item>-->
...
<!--                                    </md-menu-item>-->
                                    <md-menu-item>
                                        <router-link :to="{name: 'clockManager', params: {username: userChange.username}}" class="list_menu">ClockManager</router-link>
                                    </md-menu-item>
                                    <md-menu-item>
                                        <router-link :to="{name: 'chartManager', params: {userId: userChange.id}}" class="list_menu">ChartManager</router-link>
                                    </md-menu-item>
                                </md-menu-content>
                            </md-menu>
                        </md-card-actions>
        ...
        <md-dialog :md-active.sync="createForm.showDialog">
            ...
            <md-dialog-content>
                ...
                <md-field>
                    <label>Email</label>
                    <md-input v-model="createForm.email"></md-input>
                </md-field>
            </md-dialog-content>
            <md-dialog-actions>
